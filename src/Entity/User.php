...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[ORM\OneToMany(mappedBy: 'user', targetEntity: Nota::class, orphanRemoval: true)]
    ...
    public function addNotum(Nota $notum): self
    {
    ...
    public function removeNotum(Nota $notum): self
    {
        if ($this->nota->removeElement($notum)) {
            // set the owning side to null (unless already changed)
            if ($notum->getUser() === $this) {
                $notum->setUser(null);
            }
        }
